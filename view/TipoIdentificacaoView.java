...
public class TipoIdentificacaoView extends JFrame implements ActionListener{
   ...
   public void actionPerformed(ActionEvent e){
      if(e.getSource() == btnCadastrar){
         ...
         if(txtNome.getText().isEmpty()){
            ...
            tipoIdentificacao.setNome(txtNome.getText());
            tipoIdentificacao.insert();
   ...
   public TipoIdentificacaoView(){
   
      super("Cadastro de Tipo de Identificação");
